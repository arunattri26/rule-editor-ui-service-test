...
## Environments
- Preview: https://main--rule-editor-ui-service-test--arunattri26.hlx.page/
- Live: https://main--rule-editor-ui-service-test--arunattri26.hlx.live/
...
1. Open the `rule-editor-ui-service-test` directory in your favorite IDE and start coding :)
